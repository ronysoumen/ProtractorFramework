...
var Keywords_1 = require("./CommonFunction/Keywords");
//import {ExcelData} from '../../Config/GetTestCases';
var GetTestCases_1 = require("../../Config/GetTestCases");
var Tests;
Tests = GetTestCases_1.ExcelData.getTestcase();
var _loop_1 = function () {
    var TestRun = Tests[k];
    describe(TestRun, function () {
        var _this = this;
        var actions;
        actions = GetTestCases_1.ExcelData.getActions(TestRun);
        var _loop_2 = function () {
            var keyword = actions[i][0];
            var datsheet = actions[i][1];
            var ID = actions[i][2];
            if (GetTestCases_1.ExcelData.getTestcase().indexOf(TestRun) > -1) {
                it(keyword, function () { return __awaiter(_this, void 0, void 0, function () {
                    var e_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, Keywords_1.Keyword.fn_Execute(keyword, datsheet, ID)];
                            case 1:
                                _a.sent();
                                return [3 /*break*/, 3];
                            case 2:
